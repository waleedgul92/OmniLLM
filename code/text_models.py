...
def google_genai_text(quesion:str="What is the capital of France?"):
    ...
    response=model.generate_content(quesion,generation_config=generation_config,safety_settings=safety_settings)    
